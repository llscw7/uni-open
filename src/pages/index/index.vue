<template>
  ...
  <div class="page" :style="{ paddingTop: navbarHeight + 'px' }">
    <div class="header" :style="{ height: navbarHeight + 'px' }">
      ...
      <div class="tools-section" :style="{ top: toolsWrapTop + 'px' }">
        <div class="tools-left-wrap">
          <div class="book-btn tools-btn" @click="setPopupBookShow(true)">
        ...
        <div class="tools-right-wrap">
          ...
          <div class="filter-btn tools-btn" @click="setPopupFilterShow(true)">
    ...
    <FooterNav />
    <PopupBook :visible="popupBookShow" :set-visible="setPopupBookShow" />
    <PopupFilter :visible="popupFilterShow" :set-visible="setPopupFilterShow" /> 
...
import PopupFilter from '@/components/popup-filter/index.vue';

const popupFilterShow = ref(false);
const setPopupFilterShow = (flag: boolean) => {
  popupFilterShow.value = flag
}

const popupBookShow = ref(false);
const setPopupBookShow = (flag: boolean) => {
  popupBookShow.value = flag
}
